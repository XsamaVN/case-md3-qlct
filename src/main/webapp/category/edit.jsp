    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/home">
            <div class="sidebar-brand-icon ">
                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-wallet2"
                     viewBox="0 0 16 16">
                        ...
                        <div class="col-8">
                            ...
                            <form method="post">
                                <div class="form-group">
                                    <div class="form-group">
                                        <p>Id Category</p>  <input disabled type="text" name="name" value="${categoryEdit.id}"  class="form-control form-control-user" placeholder="Name Category">
                                    </div>
                                    <p>Name Category</p>  <input type="text" name="name" value="${categoryEdit.name}"  class="form-control form-control-user" placeholder="Name Category">
                                </div>
